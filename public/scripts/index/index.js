...
let divLoading;
let divLoaded;
let innerHTMLSkeletonLoading = "";
const getDataEq = async (dict) => {
    const res = await fetch(`${mainRoute}/getTrips`, {
        method: "POST",
        headers: {
          ...
          <div class="cardBody">
            ...
            <div class="dates">
              <p class="pStartDate">
                ...
                <span class="value">${new Date(trip.startDate || "").toDateString()}</span>
              </p>
              <p class="pEndDate">
                <span class="label">Fecha de fin: </span>
                <span class="value">${new Date(trip.endDate || "").toDateString()}</span>
              </p>
            </div>
          </div>
